...
public class SchuelerVerwaltung {
    ...
    public void fuegeSchuelerHinzu(Schueler s) {
        ...
        try (Connection conn = Database.connect();
            ...
            System.out.println("Schüler gespeichert, rows=" + rows);

        } catch (SQLException e) {
            System.out.println("Fehler bei fuegeSchuelerHinzu:");
            e.printStackTrace();
        }
    }
    ...
    public void bearbeiteSchueler(String id, String neuerName, String neueMail, String neueNummer) {
        ...
        try (Connection conn = Database.connect();
            ...
            int rows = ps.executeUpdate();
            System.out.println("Schüler UPDATE rows=" + rows);

        } catch (SQLException e) {
            System.out.println("Fehler bei bearbeiteSchueler:");
            e.printStackTrace();
        }
    }
    ...
    public void loescheSchueler(String id) {
        try (Connection conn = Database.connect()) {
            ...
            try (PreparedStatement ps3 = conn.prepareStatement(
                ...
                System.out.println("Schüler DELETE rows=" + rows);
            }

        } catch (SQLException e) {
            System.out.println("Fehler bei loescheSchueler:");
            e.printStackTrace();
        }
    }
    ...
    public Schueler findeSchueler(String id) {
        ...
        try (Connection conn = Database.connect();
            ...
            System.out.println("Fehler bei findeSchueler:");
            e.printStackTrace();
        }
    ...
    public ArrayList<Schueler> sucheSchueler(String suchbegriff) {
        ...
        try (Connection conn = Database.connect();
            ...
            System.out.println("Fehler bei sucheSchueler:");
            e.printStackTrace();
        }
    ...
    public ArrayList<Schueler> ladeAlleSchueler() {
        ...
        try (Connection conn = Database.connect();
             PreparedStatement ps = conn.prepareStatement("SELECT * FROM schueler ORDER BY id");
            ...
            System.out.println("Fehler bei ladeAlleSchueler:");
            e.printStackTrace();
        }
